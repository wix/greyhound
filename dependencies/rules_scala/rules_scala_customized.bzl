...
load("@io_bazel_rules_scala//scala/private:rules/scala_library.bzl", "make_scala_library")
...
# todo: after prime app migration, move to rules_scala_dt_off.bzl
...
scala_library = make_scala_library(
    phase_providers([
        "@greyhound//dependencies/rules_scala:dep_tracking_phase_off",
    ]),
)
